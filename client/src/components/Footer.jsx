    ...
    <footer className="bg-[#1B5E20] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#81C784]">Tennis Club Casablanca</p>
              </div>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/booking" className="text-white/70 hover:text-white transition-colors">Réservation</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              ...
              <li className="flex items-center gap-2">
                <span className="text-[#81C784]">✉️</span>
                contact@usmtcc.ma
              </li>
              <li className="flex items-center gap-2">
                <span className="text-[#81C784]">🕐</span>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/60 text-sm">© 2026 USM/TCC - Tous droits réservés</p>
